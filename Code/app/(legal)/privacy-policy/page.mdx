# Privacy Policy for GenForms.ai

## Introduction

Welcome to GenForms.ai, the **AI form generation platform** designed to help teams create, publish, collect, and integrate business forms quickly. At GenForms.ai, your privacy is important to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using GenForms.ai:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use GenForms.ai, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access GenForms.ai, such as device type, operating system, and browser type.
...
**Copyright Owner**: [genforms.ai](http://genforms.ai)
**Email**: [hello@genforms.ai](mailto:hello@genforms.ai)

By using GenForms.ai, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
