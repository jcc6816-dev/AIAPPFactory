# Privacy Policy for AI FormFactory

## Introduction

Welcome to AI FormFactory, the **AI form generation platform** designed to help teams create, publish, collect, and integrate business forms quickly. At AI FormFactory, your privacy is important to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using AI FormFactory:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use AI FormFactory, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access AI FormFactory, such as device type, operating system, and browser type.
...
**Copyright Owner**: [aiformfactory.ai](http://aiformfactory.ai)
**Email**: [hello@aiformfactory.ai](mailto:hello@aiformfactory.ai)

By using AI FormFactory, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
