# Topic: product feedback feature request
...
- **Estimated intent** (requires verification):
  - Likely: Template / example — users want feedback collection forms
  - GenForms angle: AI-generated feedback form + QR code sharing
