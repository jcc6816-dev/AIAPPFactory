# Topic: RSVP workshop / webinar registration
...
- **Estimated intent** (requires verification):
  - Likely: Template / example — users want event registration forms
  - GenForms angle: template + QR code for in-person event access
