# Topic: google forms alternative
...
- **Estimated intent** (requires verification):
  - Likely: Alternative comparison — users seeking cheaper or better alternative
  - GenForms angle: AI-native + cheaper + webhook at lower price tier
