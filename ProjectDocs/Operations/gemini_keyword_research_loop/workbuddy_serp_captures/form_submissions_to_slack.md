# Topic: form submissions to Slack
...
- **Estimated intent** (requires verification):
  - Likely: Integration / webhook — users want form-to-Slack notifications
  - GenForms angle: webhook → Slack bot (generic webhook, not native integration)
