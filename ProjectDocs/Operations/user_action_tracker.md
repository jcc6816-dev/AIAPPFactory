...
| U-044 | 等待产物 | P0 | 等待 Gemini 输出 GSC 单日曝光下滑归因报告 | Codex 已创建 `AI-TASK-2026-006-031`，要求 Gemini 基于 2026-06-08 至 2026-06-13 的 GSC 单日快照，分析曝光从 198 降到 62 的主要原因，并输出今天/3天/7天行动建议。 | Gemini 报告写入 `ProjectDocs/AI-Team/reports/gemini/AI-TASK-2026-006-031-execution-report.md` 后，Mike 交给 Codex 复核。 |
| U-045 | 等待产物 | P0 | 等待 Gemini 输出高曝光低点击页面 SERP 点击救援包 | Codex 已创建 `AI-TASK-2026-006-032`，要求 Gemini 针对 Feishu/DingTalk Webhook、Lark/Feishu Webhook、Typeform Alternatives 等页面输出克制版 title、description、TL;DR、CTA 和内链建议。 | Gemini 报告写入 `ProjectDocs/AI-Team/reports/gemini/AI-TASK-2026-006-032-execution-report.md` 后，Codex/Mike 决定是否写入后台或继续冻结观察。 |
| U-046 | 等待产物 | P0 | 等待 Gemini 输出产品激活关键事件为 0 的诊断报告 | Codex 已创建 `AI-TASK-2026-006-033`，要求 Gemini 核对首页、`/forms/new`、GA4/站内事件映射、Clarity 观察范围和登录拦截，解释为什么有 sessions 但 `demo_start`、`form_generate`、`form_publish` 等事件为 0。 | Gemini 报告写入 `ProjectDocs/AI-Team/reports/gemini/AI-TASK-2026-006-033-execution-report.md` 后，Codex 决定是否安排代码修补任务。 |
